...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <meta name="url-base" content="<?php echo e(url ('')); ?>">
    ...
    <!-- Custom styles for this template -->
    <link href="https://ssanher2810.ieszaidinvergeles.es/Laraveles/ajaxApp/public/assets/style/dashboard.css" rel="stylesheet">
    <style>
      a {
        cursor: pointer;
      }
  ...
  <body>
    ...
    <?php echo $__env->make('modal.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('modal.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('modal.delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
  ...
  function llamadaAjax(data) {
    ...
    <script src="https://ssanher2810.ieszaidinvergeles.es/Laraveles/ajaxApp/public/assets/script/dashboard.js"></script>
    <!--<script src="<?php echo e(url('assets/script/dashboard.js?r=' . rand(0, 100000))); ?>"></script> esto es para evitar problemas de caché (solo sostenible para el desarrollo)-->
  </body>
  </body>
</html><?php /**PATH /var/www/html/Laraveles/ajaxApp/resources/views/main.blade.php ENDPATH**/ ?>